...
if __name__ == '__main__':
    ...
    load_train_path = os.path.join('/media/usr/external/home/usr/project/deepfeature_data', dataset_name,
                                   'dataset/train/npy')
    ...
    load_val_path = os.path.join('/media/usr/external/home/usr/project/deepfeature_data', dataset_name,
                                  'dataset/test/npy')
    save_path = os.path.join('/media/usr/external/home/usr/project/deepfeature_data', dataset_name,
                                   model_name, 'experiment/experiment_2/DSA/1_select_data')
    for temp_rate in rate:
        retrain_model(load_train_path, load_val_path, load_adv_path, save_path, adv_list, temp_rate, model_name)
