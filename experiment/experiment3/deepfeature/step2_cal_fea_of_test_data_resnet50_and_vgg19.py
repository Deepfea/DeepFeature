            ...
            if model_name == 'resnet_50':
                ...
                for group_num in range(int(len(adv_x) / one_time_img_num) + 1):
                    ...
                    if model_name == 'resnet50':
                        gra_arr = get_gradients(model_path, temp_x, temp_y, 173, 'conv')
...
def cal_score(adv_list, cav_path, save_path):
    for adv_name in adv_list:
        for class_num in range(10):
            ...
            adv_score_arr = np.empty(len(adv_gradients), dtype='float32')
...
if __name__ == '__main__':
    ...
    test_data_path = '/media/usr/external/home/usr/project/deepfeature_data/dataset_3/resnet50/approach/3_test_data'
    cav_path = '/media/usr/external/home/usr/project/deepfeature_data/dataset_3/resnet50/approach/7_robust_feature'
    save_path = '/media/usr/external/home/usr/project/deepfeature_data/dataset_3/resnet50/experiment/experiment_2/1_get_testset_gradients_and_fea'
    model_path = '/media/usr/external/home/usr/project/deepfeature_data/dataset_3/resnet50/model/resnet50.h5'

    # get_predict_result(adv_list, model_path, test_data_path, save_path)

    # get_test_gradients(adv_list, model_name, model_path, save_path)

    classify_class(adv_list, save_path)

    cal_score(adv_list, cav_path, save_path)
